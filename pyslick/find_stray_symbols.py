...
The script prints a list of files with the line numbers and a short description
of the problem.
"""
...
def scan_file(file_path: Path):
    ...
    with file_path.open('r', encoding='utf-8') as f:
        for i, raw_line in enumerate(f, start=1):
            ...
            # Ignore self‑closing tags for stack handling
